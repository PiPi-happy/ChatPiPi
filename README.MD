# chatgpt-web
### 使用GPT-3.5中的text-davinci-003模型，利用OpenAI API实现简单HTML网页版在线聊天（基于[此项目]([https://github.com/AlliotTech/chatgpt-web](https://github.com/slippersheepig/chatgpt-web)调整而来）
